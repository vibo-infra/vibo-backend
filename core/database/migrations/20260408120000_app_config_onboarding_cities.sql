-- Canonical list of cities for app onboarding / default_city validation.
-- Edit JSON in app_config to add/remove cities or change coordinates without shipping app code.
